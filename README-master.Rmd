...
- cap_position -- Vertical positon relative to image: `above` or `below`. Default is `above`. For example, `cap_position=above`
...
- keep_with_next -- Used with *Headings* to keep them from being 'orphaned' at bottom of page. Note, its effect may be compromised if too close to an image, e.g., `keep_with_next=true`.
