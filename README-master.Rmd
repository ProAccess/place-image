...
![Now you can place and caption your images and illustrations wherever and however you like!](./images-md/happy-face-doc.png){width=40% position=float-right cap_position=above cap_text_align=center}
...
# Special considerations for floating images in latex/pdf documents{#using-wrapfig}
